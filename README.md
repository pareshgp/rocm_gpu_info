...
gpu_current_system_information.py is contains utility to get current GPU system information while running workloads. This will fetch Temperature, GPU clk, fan data, Current package power, VRAM usage, GPU usage information. To use this utilty run command as 'python3 gpu_current_system_information.py --time/-t 5 --format-f csv'
